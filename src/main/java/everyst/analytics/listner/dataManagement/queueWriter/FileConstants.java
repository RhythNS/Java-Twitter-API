...
public interface FileConstants {
	...
	public static final File FOLLOWER_TRACKER_FILE = new File(ROOT_DATA_MANAGEMENT_FILE, "followerTracker");
	public static final File FOLLOWER_TRACKER_ACCOUNTS = new File(ROOT_DATA_MANAGEMENT_FILE, "accountsToTrack");
